...
def createScene(root):
    ...
    drawDevice="1", positionBase="12 0 0",  orientationBase="0.707 0 0 0.707", forceFeedBack="@instrumentRight/LCPFF_Right")

    root.addObject('GeomagicDriver', name="GeomagicDeviceLeft", deviceName="Left Device", scale="1", drawDeviceFrame="1", 
    drawDevice="1", positionBase="-12 0 0",  orientationBase="0.707 0 0 0.707", forceFeedBack="@instrumentLeft/LCPFF_Left")
    ...
    scale3d=scale3d_needle, fixingBox=None, importFile=needleVolume_fileName, carving=carving, 
    geomagicPosition="@GeomagicDeviceRight.positionDevice")
...
scale3d=[0.0, 0.0, 0.0],  fixingBox=[0.0, 0.0, 0.0], importFile=None,  carving=False, geomagicPosition=None):
    ...
    name.addObject('MechanicalObject',  name='InstrumentMechObject', template='Rigid3d', position=geomagicPosition, scale3d=scale3d, rotation="0 0 10" ) #, src="@instrumentMeshLoader")
