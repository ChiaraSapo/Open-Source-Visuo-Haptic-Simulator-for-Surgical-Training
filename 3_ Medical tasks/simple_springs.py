...
def createScene(root):
    ...
    springs2 = [Sofa.SofaDeformable.LinearSpring(index1=i, index2=i, springStiffness=100, dampingFactor=5, restLength=1) for i in range(9)]
    ...
    if add==0:
        ...
        for i in range(5):
            print("removing")
            spring_force_field2.removeSpring(i)
    if add==1:
        print("Add spring")
