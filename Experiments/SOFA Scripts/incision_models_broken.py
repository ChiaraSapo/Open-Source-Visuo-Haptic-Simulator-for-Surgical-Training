...
def Scalpel(parentNode=None, name=None, scale3d=[0.0, 0.0, 0.0], monitor=False, file1=None, file2=None, file3=None): 
    ...
    #Surf.addObject("Monitor", name=file3, indices="0", listening="1", showForces="1", ExportForces="true")
    ...
    collFront2.addObject('MechanicalObject', template="Vec3d", name="Particle", position="4 -3.7 -8.5",  dz="4", dx="-4", dy="-3.5",  rx="0", ry="0", rz="90")
