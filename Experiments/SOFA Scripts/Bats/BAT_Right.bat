...
runSofa %SIMULPATH%\Trial_Line1_Right.py -a
runSofa %SIMULPATH%\Trial_Line2_Right.py -a
runSofa %SIMULPATH%\Trial_Line3_Right.py -a
runSofa %SIMULPATH%\Trial_Cube_Right.py -a
runSofa %SIMULPATH%\Trial_Sphere_Right.py -a
...
runSofa %SIMULPATH%\Incision_task1_Right.py -a
echo 2 >> %SIMULPATH%/Repetitions.txt
runSofa %SIMULPATH%\Incision_task1_Right.py -a
echo 3 >> %SIMULPATH%/Repetitions.txt
runSofa %SIMULPATH%\Incision_task2_Right.py -a
echo 4 >> %SIMULPATH%/Repetitions.txt
runSofa %SIMULPATH%\Incision_task2_Right.py -a
echo 5 >> %SIMULPATH%/Repetitions.txt
runSofa %SIMULPATH%\Incision_task3_Right.py -a
...
runSofa %SIMULPATH%\Rings_task_Right.py -a
...
runSofa %SIMULPATH%\Suture_task_Right.py -a
