...
data = pd.read_csv("C:/sofa/build/v20.12.02/bin/Release/RingsTask_pos_x.txt",  skiprows=[0,1], index_col=False, delim_whitespace=True, 
names=['Time', 'x1', 'y1', 'z1'])
...
data = pd.read_csv("C:/sofa/build/v20.12.02/bin/Release/RingsTask_vel_v.txt",  skiprows=[0,1], index_col=False, delim_whitespace=True, 
names=['Time', 'x1', 'y1', 'z1'])
...
data = pd.read_csv("C:/sofa/build/v20.12.02/bin/Release/RingsTask_force_f.txt",  skiprows=[0,1], index_col=False, delim_whitespace=True, 
names=['Time', 'x1', 'y1', 'z1'])
