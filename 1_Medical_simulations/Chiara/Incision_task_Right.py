...
class IncisionTaskTrainingController(Sofa.Core.Controller):
    ...
    def __init__(self, root, skin_left, skin_right):
        ...
        # Contact listeners (SkinLeft-ScalpelSphere1; SkinRight-ScalpelSphere1)
        ...
        # Contact listeners (SkinLeft-ScalpelSphere2; SkinRight-ScalpelSphere2)
        ...
        # Contact listeners (SkinLeft-ScalpelSphere3; SkinRight-ScalpelSphere3)
        ...
        # Spring force fields in each boxROI
        ...
        # Create connections between the patches
    ...
    def onAnimateBeginEvent(self, event): 
        ...
        # Check collisions between the blade collision spheres and the skin patches
        ...
        # If any collision happens break the springs
        if coll_indexes!=[]:
    ...
    # Break springs when collision on left patch
    ...
    # Break springs when collision on right patch
