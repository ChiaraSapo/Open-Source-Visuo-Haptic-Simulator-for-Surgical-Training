...
def createScene(root):
    ...
    # Add needles
    suture_models.SutureNeedle(parentNode=root, name='SutureNeedleLeft', monitor=True, file1=fileNamePos, file2=fileNameVel, file3=fileNameForce, position="@GeomagicDeviceLeft.positionDevice", external_rest_shape='@../OmniLeft/DOFs', rx=80, ry=180, rz=-20) # To fall on sphere: dx=12, dy=3, dz=
