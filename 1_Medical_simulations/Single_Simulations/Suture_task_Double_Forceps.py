...
def createScene(root):
    ...
    # Add needles
    suture_models.SutureNeedle(parentNode=root, name='SutureNeedle', monitor=True, file1=fileNamePos, file2=fileNameVel, file3=fileNameForce, position="@GeomagicDeviceRight.positionDevice", external_rest_shape='@../OmniRight/DOFs',rx=70, ry=0, rz=50) # To fall on sphere: dx=12, dy=3, dz=
    suture_models.Plier(parentNode=root, name='Forceps', monitor=True, file1=fileNamePosLeft, file2=fileNameVelLeft, file3=fileNameForceLeft, position="@GeomagicDeviceLeft.positionDevice", external_rest_shape='@../OmniLeft/DOFs', rx=0, ry=180, rz=0) # To fall on sphere: dx=12, dy=3, dz=6
