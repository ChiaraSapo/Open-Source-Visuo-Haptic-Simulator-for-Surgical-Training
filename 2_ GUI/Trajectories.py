...
def Window3(win3):
    ...
    # Read plot data
    if task_type=="Suture\n":
        data_pos = pd.read_csv("Rep6_S0_pt2_SuturePos_xfake.txt",  skiprows=[0,1], index_col=False, delim_whitespace=True, names=['Time', 'x1', 'y1', 'z1'])
        data_vel = pd.read_csv("Rep6_S0_pt2_SutureVel_vfake.txt",  skiprows=[0,1], index_col=False, delim_whitespace=True, names=['Time', 'x1', 'y1', 'z1'])
        data_force = pd.read_csv("Rep6_S0_pt2_SutureVel_v.txt",  skiprows=[0,1], index_col=False, delim_whitespace=True, names=['Time', 'x1', 'y1', 'z1'])
