...
def createScene(root):
    ...
    fileNamePos=f"Rep{RepNumber}_{user_name}_Incision4Pos"
    fileNameVel=f"Rep{RepNumber}_{user_name}_Incision4Vel"
    fileNameForce=f"Rep{RepNumber}_{user_name}_Incision4Force"
