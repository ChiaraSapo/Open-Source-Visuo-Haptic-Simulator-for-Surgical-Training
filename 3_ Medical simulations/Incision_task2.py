...
def createScene(root):
    ...
    fileNamePos=f"Rep{RepNumber}_{user_name}_Incision2Pos"
    fileNameVel=f"Rep{RepNumber}_{user_name}_Incision2Vel"
    fileNameForce=f"Rep{RepNumber}_{user_name}_Incision2Force"
