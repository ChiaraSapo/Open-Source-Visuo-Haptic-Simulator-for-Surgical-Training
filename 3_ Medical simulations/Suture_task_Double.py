...
def createScene(root):
    ...
    drawDevice="0", positionBase="20 20 0",  orientationBase="0.707 0 0 0.707", forceFeedBack="@SutureNeedle/LCPFFNeedle")

    root.addObject('GeomagicDriver', name="GeomagicDeviceLeft", deviceName="Left Device", scale="1", drawDeviceFrame="1", 
    drawDevice="0", positionBase="0 20 0",  orientationBase="0.707 0 0 0.707", forceFeedBack="@SutureNeedleLeft/LCPFFNeedle")
...
class SutureTrainingContactControllerDoubleHaptic(Sofa.Core.Controller):
    ...
    # @param sutColl_FRONT: path to the needle collision front model (may be the right or left needle)
    # @param sutColl_FRONT: path to the needle collision back model (may be the right or left needle)
