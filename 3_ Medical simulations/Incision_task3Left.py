...
def createScene(root):
    ...
    fileNamePos=f"Rep{RepNumber}_{user_name}_Incision3Pos_DoubleLeft"
    fileNameVel=f"Rep{RepNumber}_{user_name}_Incision3Vel_DoubleLeft"
    fileNameForce=f"Rep{RepNumber}_{user_name}_Incision3Force_DoubleLeft"
