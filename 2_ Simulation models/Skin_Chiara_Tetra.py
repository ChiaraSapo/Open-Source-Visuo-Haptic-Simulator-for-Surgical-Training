...
def createScene(root):
    ...
    # Mass
    skin.addObject('DiagonalMass', name="SkinMass", template="Vec3d,double", massDensity="1.0")#, totalMass="10")
    ...
    instrument.addObject('EulerImplicitSolver',  name="ODE solver")#, rayleighStiffness="0.01", rayleighMass="1")
    ...
    instrument.addObject('RestShapeSpringsForceField', stiffness='100000', angularStiffness='100000', external_rest_shape='@../Omni/DOFs', points='0', external_points='0') #DANI
